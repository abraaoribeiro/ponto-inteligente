...
public class LancamentoServiceTest {
	...
	@Test
	public void testBuscarLancamentoPorFuncioanarioId() {
		Page<Lancamento> lancamento = this.lancamentoService.buscarPoFuncionario(1l, new PageRequest(0, 10));
		assertNotNull(lancamento);
	}

	@Test
	public void testBucandoLacamentoId() {
